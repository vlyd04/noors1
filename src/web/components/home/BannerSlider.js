        ...
        return (
            <>
                ...
                >
                    ...
                    {
                        this.state.bannerList.filter(x=>x.ThemeTypeID == 1)?.map((item, idx) =>

                            <div key={item.BannerId} className="main-banner" style={{ backgroundImage: `url(${this.state.adminPanelBaseURL + item.BannerImgUrl})` }}>
