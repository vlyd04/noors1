                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td className="order-subtotal-price">
                                            <span className="order-subtotal-amount">{GetDefaultCurrencySymbol()}{CartSubTotal}</span>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td className="product-subtotal">
                                            <span className="subtotal-amount">{GetDefaultCurrencySymbol()}{OrderTotal}</span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
