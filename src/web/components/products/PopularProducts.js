            ...
            <section className="products-area pt-60 pb-30">
                <div className="container">
                    <div className="section-title">
                        <div className='row'>
                            <div className='col-6'>
                                <h2 style={{ float: "left" }}><span className="dot"></span> <span id="lbl_popprd_title">
                            ...
                            <div className='col-6'>
                                <div className="products-view-all">
                                    <Link to={`/${getLanguageCodeFromSession()}/all-products/0/popular-products`} id="lbl_popprd_viewall">
                                        {LocalizationLabelsArray.length > 0 ?
