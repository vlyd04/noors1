                ...
                <div className="container">
                    <div className="signup-content">
                        ...
                        <form className="signup-form" onSubmit={handleUpdateProfileForm}>
                            ...
                            <button type="submit" className="btn btn-primary" id="lbl_uprofile_submit">
                                {LocalizationLabelsArray.length > 0 ?
                            ...
                            <Link to={`/${getLanguageCodeFromSession()}/`} className="return-store" id="lbl_uprofile_gohome">
                                {LocalizationLabelsArray.length > 0 ?
