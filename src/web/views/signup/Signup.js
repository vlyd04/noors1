                    ...
                    <div className="signup-content">
                        ...
                        <form className="signup-form" onSubmit={handleSignupForm}>
                            ...
                            <button type="submit" className="btn btn-primary" id="lbl_singup_submitbnt">
                                {LocalizationLabelsArray.length > 0 ?
                                    replaceLoclizationLabel(LocalizationLabelsArray, "Signup", "lbl_singup_submitbnt")
                                    :
                                    "Signup"
                                }  
                            </button>

                            <Link to={`/${getLanguageCodeFromSession()}/login`} className="return-store" id="lbl_singup_loginacnt">
                                {LocalizationLabelsArray.length > 0 ?
                                    replaceLoclizationLabel(LocalizationLabelsArray, "or Login to your account", "lbl_singup_loginacnt")
                                    :
